        ...
        <div class="content-header">
                        <div class="container-fluid">
                            ...
                            <div class="col-sm-6">
                                ...
                                <li class="breadcrumb-item active"><a href="{{ route('user.create') }}" role="button" class="btn btn-success">ENREGISTRER USER</a></li>
                                </ol>
                            </div><!-- /.col -->
                            </div><!-- /.row -->
                        </div><!-- /.container-fluid -->
...
<div class="col-12">
    <div class="card border-danger border-0">
        <div class="card-header bg-success text-center">LISTE D'ENREGISTREMENT DES USERS</div>
            <div class="card-body">
                <table id="example1" class="table table-bordered table-responsive-md table-striped text-center">
                    ...
                    @foreach ($users as $user)
                        <tr>
                            ...
                            <td>{{ $user->email }}</td>
                            <td>{{ $user->role }} </td>
                         <td> @if($user->projet){{ $user->projet->nom }}@endif</td>
